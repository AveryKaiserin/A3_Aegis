...
{
	uniformClass = B_ACU_massif_ocp_CS_1;
};
...
class B_officer_combat_F: B_officer_F
{
...
class B_recon_M_F: B_Soldier_recon_base
{
	...
	uniformClass = B_ACU_massif_ocp_tshirt_1;
    weapons[] =
    {
...
{
    editorPreview = "\A3_HARM\EditorPreviews_F_HARM\Data\CfgVehicles\B_Patrol_HeavyGunner_F.jpg";
	uniformClass = B_ACU_massif_ocp_CS_1;
    scope = protected;
    scopeCurator = private;
	linkedItems[] =
...
{
    editorPreview = "\A3_HARM\EditorPreviews_F_HARM\Data\CfgVehicles\B_Patrol_Soldier_A_F.jpg";
	uniformClass = B_ACU_massif_ocp_CS_1;
    scope = protected;
    scopeCurator = private;
	linkedItems[] =
...
class B_Patrol_Soldier_MG_F: B_Soldier_MG_F
{
    scope = protected;
    scopeCurator = private;
};

class U_IG_Guerilla3_3_F: Uniform_Base
{
	...
	{
		uniformModel = "-";
		uniformClass = I_T_Guerilla3_3_F;
		containerClass = Supply30;
		mass = 30;
	};
};
class U_I_T_Uniform_01_hex_F: Uniform_Base
{
	author = $STR_A3_A_AveryTheKitty;
	scope = public;
	...
	{
		uniformModel = "-";
		uniformClass = I_T_Uniform_01_hex_F;
		containerClass = Supply40;
		mass = 40;
	};
};
class U_I_T_Uniform_01_urb_F: Uniform_Base
{
	author = $STR_A3_A_AveryTheKitty;
	scope = public;
	...
	{
		uniformModel = "-";
		uniformClass = I_T_Uniform_01_urb_F;
		containerClass = Supply40;
		mass = 40;
	};
};
class U_I_T_Uniform_01_ghex_F: Uniform_Base
{
	author = $STR_A3_A_AveryTheKitty;
	scope = public;
	...
	{
		uniformModel = "-";
		uniformClass = I_T_Uniform_01_ghex_F;
		containerClass = Supply40;
		mass = 40;
	};
};
class U_I_T_Uniform_01_tshirt_black_F: Uniform_Base
{
	author = $STR_A3_A_AveryTheKitty;
	scope = public;
	...
	{
		uniformModel = "-";
		uniformClass = I_T_Uniform_01_tshirt_black_F;
		containerClass = Supply30;
		mass = 30;
	};
};
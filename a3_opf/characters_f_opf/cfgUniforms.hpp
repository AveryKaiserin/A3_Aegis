...
class Opf_O_S_Uniform_01_taiga_F: O_G_Soldier_SL_F
{
	...
	{
		"\A3_Aegis\Characters_F_Aegis\Uniforms\Data\Officer_RUtaiga_CO.paa",
		"\A3_Aegis\Characters_F_Aegis\Uniforms\Data\O_S_Uniform_01_taiga_2_CO.paa"
	};
};
class Opf_O_S_Uniform_01_arid_F: Opf_O_S_Uniform_01_taiga_F
{
	...
	hiddenSelectionsTextures[] =
    {
        "\A3_Aegis\Characters_F_Aegis\Uniforms\Data\Officer_RUarid_CO.paa",

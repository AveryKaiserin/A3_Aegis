...
class CfgVehicles
{
    ...
    /*
	VEST_HOLDER(V_HarnessO_owcamo,$STR_A3_A_CfgWeapons_V_HarnessO_owcamo0)
	VEST_HOLDER(V_HarnessOGL_owcamo,$STR_A3_A_CfgWeapons_V_HarnessOGL_owcamo0)
    */
	VEST_HOLDER(V_HarnessOSpec_tan,$STR_A3_A_CfgWeapons_V_HarnessOSpec_tan0)
    /*
	VEST_HOLDER(V_HarnessOSpec_owcamo,$STR_A3_A_CfgWeapons_V_HarnessOSpec_owcamo0)
    */

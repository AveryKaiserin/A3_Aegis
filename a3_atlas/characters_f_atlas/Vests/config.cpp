...
class CfgWeapons
{
	...
	class V_CarrierRigKBT_01_Green_F: V_CarrierRigKBT_01_base_F
	{
		...
		//picture = "\A3_Atlas\Characters_F_Atlas\Vests\Data\UI\icon_V_CarrierRigKBT_01_Green_F_CA.paa";
		hiddenSelectionsTextures[] = {"\A3_Atlas\Characters_F_Atlas\Vests\Data\CarrierRigKBT_01_Green_CO.paa"};
	};
	class V_CarrierRigKBT_01_light_Green_F: V_CarrierRigKBT_01_light_base_F
	{
		...
		//picture = "\A3_Atlas\Characters_F_Atlas\Vests\Data\UI\icon_V_CarrierRigKBT_01_light_Green_F_CA.paa";
		hiddenSelectionsTextures[] = {"\A3_Atlas\Characters_F_Atlas\Vests\Data\CarrierRigKBT_01_Green_CO.paa"};
	};
	class V_CarrierRigKBT_01_heavy_Green_F: V_CarrierRigKBT_01_heavy_base_F
	{
		...
		//picture = "\A3_Atlas\Characters_F_Atlas\Vests\Data\UI\icon_V_CarrierRigKBT_01_heavy_Green_F_CA.paa";
		hiddenSelectionsTextures[] = {"\A3_Atlas\Characters_F_Atlas\Vests\Data\CarrierRigKBT_01_Green_CO.paa"};
	};
};
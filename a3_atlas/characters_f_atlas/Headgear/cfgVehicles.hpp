...
class CfgVehicles
{
	...
	HEADGEAR_HOLDER(H_HelmetB_ADF_Tropic,$STR_A3_A_CfgWeapons_H_HelmetB_ADF_Tropic0,EdSubcat_Helmets)
	HEADGEAR_HOLDER(H_HelmetB_ADF_Woodland,$STR_A3_A_CfgWeapons_H_HelmetB_ADF_Woodland0,EdSubcat_Helmets)
	HEADGEAR_HOLDER(H_HelmetB_ADF_Arid,$STR_A3_A_CfgWeapons_H_HelmetB_ADF_Arid0,EdSubcat_Helmets)
    /*

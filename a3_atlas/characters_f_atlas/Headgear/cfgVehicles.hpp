...
class CfgVehicles
{
	...
	// Arma 3 Atlas
	HEADGEAR_HOLDER(H_HelmetO_tkcamo,$STR_A3_A_CfgWeapons_H_HelmetO_tkcamo0,EdSubcat_Helmets)
	HEADGEAR_HOLDER(H_HelmetLeaderO_tkcamo,$STR_A3_A_CfgWeapons_H_HelmetLeaderO_tkcamo0,EdSubcat_Helmets)
	HEADGEAR_HOLDER(H_HelmetSpecO_tkcamo,$STR_A3_A_CfgWeapons_H_HelmetSpecO_tkcamo0,EdSubcat_Helmets)
	...
	HEADGEAR_HOLDER(H_Booniehat_tkcamo,$STR_A3_A_CfgWeapons_H_Booniehat_tkcamo0,EdSubcat_Hats)
	HEADGEAR_HOLDER(H_Booniehat_tkcamo_hs,$STR_A3_A_CfgWeapons_H_Booniehat_tkcamo_hs0,EdSubcat_Hats)
	...
	HEADGEAR_HOLDER(H_MilCap_tkcamo,$STR_A3_A_CfgWeapons_H_MilCap_tkcamo0,EdSubcat_Hats)

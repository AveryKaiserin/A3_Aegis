class U_I_CDF_Uniform_01_F: Uniform_Base
{
	author = $STR_A3_A_AveryTheKitty;
	scope = public;
	displayName = $STR_A3_A_CfgWeapons_U_I_CDF_Uniform_01_F0;
	//picture = "\A3_Atlas\Characters_F_Atlas\Uniforms\Data\UI\icon_U_I_CDF_Uniform_01_F_CA.paa";
	...
	{
		uniformModel = "-";
		uniformClass = I_CDF_Uniform_01_F;
		containerClass = Supply40;
		mass = 40;
	};
};
class U_I_CDF_Uniform_01_tanktop_F: Uniform_Base
{
	author = $STR_A3_A_AveryTheKitty;
	scope = public;
	...
	{
		uniformModel = "-";
		uniformClass = I_CDF_Uniform_01_tanktop_F;
		containerClass = Supply40;
		mass = 40;
	};
};
class U_I_CDF_Uniform_01_shortsleeve_F: Uniform_Base
{
	author = $STR_A3_A_AveryTheKitty;
	scope = public;
	...
	{
		uniformModel = "-";
		uniformClass = I_CDF_Uniform_01_shortsleeve_F;
		containerClass = Supply40;
		mass = 40;
	};
};
class U_I_CDF_Uniform_01_officer_F: Uniform_Base
{
	author = $STR_A3_A_AveryTheKitty;
	scope = public;
	...
	{
		uniformModel = "-";
		uniformClass = I_CDF_Uniform_01_officer_F;
		containerClass = Supply40;
		mass = 40;
	};
};
class U_I_CDF_Uniform_01_sweater_F: Uniform_Base
{
	author = $STR_A3_A_AveryTheKitty;
	scope = public;
	displayName = $STR_A3_A_CfgWeapons_U_I_CDF_Uniform_01_sweater_F0;
	//picture = "\A3_Atlas\Characters_F_Atlas\Uniforms\Data\UI\icon_U_I_CDF_Uniform_01_sweater_F_CA.paa";
	model = "\A3\Characters_F\Common\Suitpacks\suitpack_universal_F.p3d";
	hiddenSelections[] = {camo};
	...
	{
		uniformModel = "-";
		uniformClass = I_CDF_Uniform_01_sweater_F;
		containerClass = Supply40;
		mass = 40;
	};
};
class U_I_CDF_Uniform_01_coveralls_F: Uniform_Base
{
	author = $STR_A3_A_AveryTheKitty;
	scope = public;
	displayName = $STR_A3_A_CfgWeapons_U_I_CDF_Uniform_01_coveralls_F0;
	//picture = "\A3_Atlas\Characters_F_Atlas\Uniforms\Data\UI\icon_U_I_CDF_Uniform_01_coveralls_F_CA.paa";
	...
	{
		uniformModel = "-";
		uniformClass = I_CDF_Uniform_01_coveralls_F;
		containerClass = Supply60;
		mass = 80;
	};
};
class U_I_CDF_FullGhillie_wdl_F: Uniform_Base
{
	author = $STR_A3_A_AveryTheKitty;
	scope = public;
	...
	{
		uniformModel = "-";
		uniformClass = I_CDF_ghillie_wdl_F;
        containerClass = Supply60;
        mass = 80;
	};
};
class U_I_CDF_CBRN_Suit_01_Autumn_F: Uniform_Base
{
	author = $STR_A3_A_AveryTheKitty;
	scope = public;
	...
	{
		uniformModel = "-";
		uniformClass = I_CDF_CBRN_Man_Oversuit_01_Autumn_F;

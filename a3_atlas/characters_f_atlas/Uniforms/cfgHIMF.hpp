...
class Atlas_U_B_H_Commando_F: Uniform_Base
{
	author = "BranFlakes";
	scope = public;
	displayName = $STR_A3_A_CfgWeapons_U_B_H_Commando_F0;
	//picture = "\A3_Atlas\Characters_F_Atlas\Uniforms\Data\UI\icon_U_B_H_Soldier_F_CA.paa";
	model = "\A3\Characters_F\Common\Suitpacks\suitpack_universal_F.p3d";
	hiddenSelections[] = {camo};
	...
	{
		uniformModel = "-";
		uniformClass = Atlas_B_H_CombatFatigues_Commando_F;
		containerClass = Supply40;
		mass = 40;
	};
};
class Atlas_U_B_H_Commando_2_F: Uniform_Base
{
	author = "BranFlakes";
	scope = public;
	displayName = $STR_A3_A_CfgWeapons_U_B_H_Commando_2_F0;
	//picture = "\A3_Atlas\Characters_F_Atlas\Uniforms\Data\UI\icon_U_B_H_Soldier_F_CA.paa";
	model = "\A3\Characters_F\Common\Suitpacks\suitpack_universal_F.p3d";
	hiddenSelections[] = {camo};
	hiddenSelectionsTextures[] = {"\A3_Atlas\Characters_F_Atlas\Uniforms\Data\U_B_H_Commando_F_CO.paa"};
	...
	{
		uniformModel = "-";
		uniformClass = Atlas_B_H_CombatFatigues_RolledUp_Commando_F;
		containerClass = Supply40;
		mass = 40;
	};
};
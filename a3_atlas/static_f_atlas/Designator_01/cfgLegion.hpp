class B_L_Static_Designator_01_F: B_Static_Designator_01_F
{
	...
	//editorPreview = "\A3_Atlas\EditorPreviews_F_Atlas\Data\CfgVehicles\B_L_Static_Designator_01_F.jpg";
	side = TWest;
	faction = BLU_L_F;
	crew = B_UAV_AI;
	hiddenSelections[] =

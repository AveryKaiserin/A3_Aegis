class I_I_Static_AA_F: I_static_AA_F
{
	...
	displayName = $STR_A3_A_CfgVehicles_I_I_Static_AA_F0;
	faction = IND_I_F;
	crew = I_I_Soldier_F;
	hiddenSelections[] =
	{
...
class I_I_AA_01_weapon_F: Weapon_Bag_Base
{
	author = $STR_A3_A_AveryTheKitty;
	scope = public;
	...
	faction = IND_I_F;
	displayName = $STR_A3_A_CfgVehicles_I_I_AA_01_weapon_F0;
	...
	{
        displayName = $STR_A3_A_CfgVehicles_I_I_AA_01_weapon_F_assembleInfo0;
        assembleTo = I_I_Static_AA_F;

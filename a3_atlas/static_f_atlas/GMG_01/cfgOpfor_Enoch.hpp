class O_W_GMG_01_F: O_GMG_01_F
{
	...
	editorPreview = "\A3_Aegis\EditorPreviews_F_Aegis\Data\CfgVehicles\O_W_GMG_01_F.jpg";
	faction = OPF_W_F;
	crew = O_W_Soldier_F;
	class assembleInfo
	{
...
{
	author = $STR_A3_A_AveryTheKitty;
	editorPreview = "\A3_Aegis\EditorPreviews_F_Aegis\Data\CfgVehicles\O_W_GMG_01_high_F.jpg";
	faction = OPF_W_F;
	crew = O_W_Soldier_F;
	class assembleInfo
	{

class I_CDF_APC_Tracked_02_cannon_F: O_APC_Tracked_02_cannon_F
{
...
class I_CDF_APC_Tracked_02_AA_F: O_APC_Tracked_02_AA_F
{
	author = $STR_A3_A_AveryTheKitty;
    class SimpleObject
	{
...
class I_CDF_APC_Tracked_02_medical_F: APC_Tracked_02_medical_base_F
{
	author = $STR_A3_A_AveryTheKitty;
    class SimpleObject
	{
	...
	//editorPreview = "\A3_Atlas\EditorPreviews_F_Atlas\Data\CfgVehicles\I_CDF_APC_Tracked_02_medical_F.jpg";
	scope = public;
	scopeCurator = public;

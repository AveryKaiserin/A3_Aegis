class O_W_Truck_02_F: O_Truck_02_covered_F
{
	...
	editorPreview = "\A3_Aegis\EditorPreviews_F_Aegis\Data\CfgVehicles\O_W_Truck_02_F.jpg";
	scope = public;
	scopeCurator = public;
	side = TEast;
	faction = OPF_W_F;
...
class O_W_Truck_02_transport_F: O_Truck_02_transport_F
{
    ...
    editorPreview = "\A3_Aegis\EditorPreviews_F_Aegis\Data\CfgVehicles\O_W_Truck_02_transport_F.jpg";
    scope = public;
    scopeCurator = public;
    side = TEast;
    faction = OPF_W_F;
...
class O_W_Truck_02_cargo_F: Truck_02_cargo_base_F
{
	...
	editorPreview = "\A3_Aegis\EditorPreviews_F_Aegis\Data\CfgVehicles\O_W_Truck_02_cargo_F.jpg";
	scope = public;
	scopeCurator = public;

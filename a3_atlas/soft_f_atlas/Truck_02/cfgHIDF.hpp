class B_HIDF_Truck_02_F: Truck_02_base_F
{
	...
	//editorPreview = "\A3_Atlas\EditorPreviews_F_Atlas\Data\CfgVehicles\B_HIDF_Truck_02_F.jpg";
	scope = public;
	scopeCurator = public;
	side = TWest;
	faction = BLU_HIDF_F;
	crew = B_HIDF_Soldier_F;
...
class B_HIDF_Truck_02_transport_F: Truck_02_transport_base_F
{
	author = $STR_A3_A_AveryTheKitty;
	class SimpleObject
	{
	...
	//editorPreview = "\A3_Atlas\EditorPreviews_F_Atlas\Data\CfgVehicles\B_HIDF_Truck_02_transport_F.jpg";
	scope = public;
	scopeCurator = public;
...
class B_HIDF_Truck_02_cargo_F: Truck_02_cargo_base_F
{
	author = $STR_A3_A_AveryTheKitty;
	class SimpleObject
	{
	...
	//editorPreview = "\A3_Atlas\EditorPreviews_F_Atlas\Data\CfgVehicles\B_HIDF_Truck_02_cargo_F.jpg";
	scope = public;
	scopeCurator = public;

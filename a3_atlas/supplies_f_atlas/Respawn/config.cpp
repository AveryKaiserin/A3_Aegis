...
class CfgVehicles
{
	...
	class B_TacticalPack_jungle;
	class Respawn_RallyPoint_01_jungle_F: Land_RallyPoint_01_base_F
	{
	...
	class B_H_Respawn_RallyPoint_01_bag_F: B_TacticalPack_jungle
	{
		author = $STR_A3_A_AveryTheKitty;
		...
		class assembleInfo
		{
			primary = true;
			base = "";
			assembleTo = Respawn_RallyPoint_01_jungle_F;
			displayName = $STR_A3_A_CfgVehicles_Land_RallyPoint_01_base_F0;
			dissasembleTo[] = {};
		};
	};

class B_E_Heli_light_03_dynamicLoadout_F: Heli_light_03_dynamicLoadout_base_F
{
	...
	//editorPreview = "\A3_Atlas\EditorPreviews_F_Atlas\Data\CfgVehicles\B_E_Heli_light_03_dynamicLoadout_F.jpg";
	scope = public;
	side = TWest;
	faction = BLU_E_F;
	crew = B_E_Helipilot_F;
	typicalCargo[] = {B_E_Soldier_Lite_F};
	hiddenSelections[] =
	{
		camo,
		ammobox,
...
class B_E_Heli_light_03_unarmed_F: Heli_light_03_unarmed_base_F
{
	author = $STR_A3_A_AveryTheKitty;
    class SimpleObject
	{
	...
	//editorPreview = "\A3_Atlas\EditorPreviews_F_Atlas\Data\CfgVehicles\B_E_Heli_light_03_unarmed_F.jpg";
	scope = public;
	side = TWest;
	faction = BLU_E_F;
	crew = B_E_Helipilot_F;
	...
	hiddenSelectionsTextures[] = {"\A3_Atlas\Air_F_Atlas\Heli_Light_03\Data\Heli_Light_03_base_wdl_CO.paa"};
	textureList[] = {Woodland,1};
	class TransportMagazines
	{
		mag_xx(SmokeShell,2);

class O_C_Heli_Light_02_dynamicLoadout_F: O_Heli_Light_02_dynamicLoadout_F
{
	...
	side = TEast;
	faction = OPF_C_F;
	crew = O_C_Helipilot_F;
	typicalCargo[] = {O_C_Helipilot_F};
	textureList[] =
	{
		Hex,1,
		Black,0,
...
class O_C_Heli_Light_02_unarmed_F: O_Heli_Light_02_unarmed_F
{
	author = $STR_A3_A_AveryTheKitty;
    class SimpleObject
	{

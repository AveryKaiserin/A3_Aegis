class I_I_Heli_Light_01_F: Heli_Light_01_unarmed_base_F
{
	...
	//editorPreview = "\A3_Atlas\EditorPreviews_F_Atlas\Data\CfgVehicles\I_I_Heli_Light_01_F.jpg";
	scope = public;
	side = TGuerrila;
	faction = IND_I_F;
...
class I_I_Heli_Light_01_dynamicLoadout_F: Heli_Light_01_dynamicLoadout_base_F
{
	author = $STR_A3_A_AveryTheKitty;
	class SimpleObject
	{
	...
	//editorPreview = "\A3_Atlas\EditorPreviews_F_Atlas\Data\CfgVehicles\I_I_Heli_Light_01_dynamicLoadout_F.jpg";
	scope = public;
	side = TGuerrila;
	faction = IND_I_F;
	crew = I_I_Helipilot_F;
...
class I_I_Heli_Light_01_recon_F: Heli_Light_01_recon_base_F
{
	author = $STR_A3_A_AveryTheKitty;
    class SimpleObject
	{
	...
	//editorPreview = "\A3_Atlas\EditorPreviews_F_Atlas\Data\CfgVehicles\I_I_Heli_Light_01_recon_F.jpg";
	scope = protected;

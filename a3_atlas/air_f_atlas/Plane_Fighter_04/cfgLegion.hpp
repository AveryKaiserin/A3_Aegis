class B_L_Plane_Fighter_04_F: Plane_Fighter_04_Base_F
{
	...
	//editorPreview = "\A3_Atlas\EditorPreviews_F_Atlas\Data\CfgVehicles\B_L_Plane_Fighter_01_F.jpg";
	scope = public;
	scopeCurator = public;
	displayName = $STR_A3_Fighter_04_name;
	side = TWest;
	faction = BLU_L_F;
	crew = B_L_Fighter_Pilot_F;
	typicalCargo[] = {B_L_Fighter_Pilot_F};
	textureList[] = {Blufor,1};
	hiddenSelectionsTextures[] =
	{
		"\A3_Atlas\Air_F_Atlas\Plane_Fighter_04\Data\Fighter_04_fuselage_01_BLUFOR_CO.paa",
		"\A3_Atlas\Air_F_Atlas\Plane_Fighter_04\Data\Fighter_04_fuselage_02_BLUFOR_CO.paa",
	...
	{
		EjectionSeatClass = B_L_Ejection_Seat_Plane_Fighter_04_F;
	};
};
class B_L_Ejection_Seat_Plane_Fighter_04_F: Ejection_Seat_Plane_Fighter_04_base_F
{
	class SimpleObject
	{
		eden = false;

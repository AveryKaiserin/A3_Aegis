...
class Box_T_East_WpsSpecial_F: Box_East_WpsSpecial_F
{
	...
	class TransportWeapons
	{
		...
		weap_xx(srifle_DMR_05_ghex_F,1);
...
class Box_T_CSAT_Equip_F: Box_CSAT_Equip_F
{
	...
	class TransportItems
	{
		...
		item_xx(G_O_Diving_ghex_F,2);
	};
	class TransportBackpacks
	{
		bag_xx(B_AssaultPack_ghex_F,2);
		bag_xx(B_Bergen_ghex_F,2);
		bag_xx(B_FieldPack_ghex_F,2);
		bag_xx(B_Carryall_ghex_F,2);
		bag_xx(B_TacticalPack_ghex_F,2);
		bag_xx(B_ViperHarness_ghex_F,2);
		bag_xx(B_ViperLightHarness_ghex_F,2);
  	};
};
class Box_T_CSAT_Uniforms_F: Box_CSAT_Uniforms_F
{
	...
	class TransportItems
	{
		...
		item_xx(U_O_T_Soldier_02_F,4);
		item_xx(U_O_T_Officer_F,4);
		item_xx(U_O_T_officer_noInsignia_ghex_F,4);
		item_xx(U_O_SpecopsUniform_blk,4);
		item_xx(U_O_T_Pilot_F,4);
		item_xx(U_O_T_Sniper_F,4);
		item_xx(U_O_T_FullGhillie_tna_F,4);
		item_xx(U_O_T_Diver_F,4);
		item_xx(U_O_V_Soldier_Viper_F,4);
	};
};
...
class Box_T_East_Support_F: Box_East_Support_F
{
	...
	class TransportItems
	{
		...
		item_xx(muzzle_snds_58_ghex_F,5);

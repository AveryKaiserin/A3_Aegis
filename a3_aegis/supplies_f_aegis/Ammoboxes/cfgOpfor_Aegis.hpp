// Arma 3 Aegis
class Box_W_East_Wps_F: ReammoBox_F
{
	...
	editorPreview = "\A3_Aegis\EditorPreviews_F_Aegis\Data\CfgVehicles\Box_W_East_Wps_F.jpg";
	scope = public;
	displayName = $STR_A3_A_CfgVehicles_Box_W_East_Wps_F0;
...
class Box_W_East_Ammo_F: ReammoBox_F
{
	author = $STR_A3_A_AveryTheKitty;
	class SimpleObject
	{
	...
	editorPreview = "\A3_Aegis\EditorPreviews_F_Aegis\Data\CfgVehicles\Box_W_East_Ammo_F.jpg";
	scope = public;
	displayName = $STR_A3_A_CfgVehicles_Box_W_East_Ammo_F0;
...
class Box_W_East_WpsLaunch_F: ReammoBox_F
{
	author = $STR_A3_A_AveryTheKitty;
	mapSize = 1.76;
	class SimpleObject
	...
	editorPreview = "\A3_Aegis\EditorPreviews_F_Aegis\Data\CfgVehicles\Box_W_East_WpsLaunch_F.jpg";
	scope = public;
	displayName = $STR_A3_A_CfgVehicles_Box_W_East_WpsLaunch_F0;
...
class O_W_supplyCrate_F: O_supplyCrate_F
{
	...
	editorPreview = "\A3_Aegis\EditorPreviews_F_Aegis\Data\CfgVehicles\O_W_supplyCrate_F.jpg";

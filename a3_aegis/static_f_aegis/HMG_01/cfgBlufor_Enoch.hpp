class B_W_HMG_01_F: B_HMG_01_F
{
	...
	editorPreview = "\A3_Aegis\EditorPreviews_F_Aegis\Data\CfgVehicles\B_W_HMG_01_F.jpg";
	faction = BLU_W_F;
	crew = B_W_Soldier_F;
	class assembleInfo
	{
...
class B_W_HMG_01_high_F: B_HMG_01_high_F
{
	author = $STR_A3_A_AveryTheKitty;
	editorPreview = "\A3_Aegis\EditorPreviews_F_Aegis\Data\CfgVehicles\B_W_HMG_01_high_F.jpg";
	faction = BLU_W_F;
	crew = B_W_Soldier_F;
	class assembleInfo
	{
...
class B_W_HMG_01_A_F: B_HMG_01_A_F
{
	author = $STR_A3_A_AveryTheKitty;
	editorPreview = "\A3_Aegis\EditorPreviews_F_Aegis\Data\CfgVehicles\B_W_HMG_01_A_F.jpg";
	faction = BLU_W_F;
	class assembleInfo
	{
		displayName = "";

...
class O_R_Static_Designator_02_F: Static_Designator_02_base_F
{
	...
	class assembleInfo
	{
		...
		base = "";
		primary = false;
		dissasembleTo[] = {O_R_Static_Designator_02_weapon_F};
	};
};
class O_R_Static_Designator_02_weapon_F: O_Static_Designator_02_weapon_F
{
	...
	scope = public;
	scopeCurator = public;
	displayName = $STR_A3_A_CfgVehicles_O_R_Static_Designator_02_weapon_F0;
	faction = OPF_R_F;
...
// Russia (Arid)
class O_R_Static_Designator_02_ard_F: Static_Designator_02_base_F
{
	author = $STR_A3_A_AveryTheKitty;
	class SimpleObject
	{

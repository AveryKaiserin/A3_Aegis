class B_A_Static_AT_F: B_static_AT_F
{
	...
	editorPreview = "\A3_Aegis\EditorPreviews_F_Aegis\Data\CfgVehicles\B_A_Static_AT_F.jpg";
	faction = BLU_A_F;
	crew = B_A_Soldier_F;
	hiddenSelections[] =
	{
...
class B_A_Static_AT_tna_F: B_A_Static_AT_F
{
	author = $STR_A3_A_AveryTheKitty;
	class SimpleObject
	{
	...
	editorPreview = "\A3_Aegis\EditorPreviews_F_Aegis\Data\CfgVehicles\B_A_Static_AT_tna_F.jpg";
	faction = BLU_A_tna_F;
...
class B_A_Static_AT_wdl_F: B_A_Static_AT_F
{
	author = $STR_A3_A_AveryTheKitty;
	class SimpleObject
	{
	...
	editorPreview = "\A3_Aegis\EditorPreviews_F_Aegis\Data\CfgVehicles\B_A_Static_AT_wdl_F.jpg";
	faction = BLU_A_wdl_F;

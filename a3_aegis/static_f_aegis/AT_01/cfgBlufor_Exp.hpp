class B_AT_01_Weapon_grn_F: Weapon_Bag_Base
{
	...
	faction = BLU_T_F;
	displayName = $STR_A3_A_CfgVehicles_B_AT_01_Weapon_grn_F0;
	...
	{
		displayName = $STR_A3_A_CfgVehicles_B_AT_01_Weapon_grn_F_assembleInfo0;
		assembleTo = B_T_Static_AT_F;
		base[] =
		{
            B_HMG_01_support_F,
            O_HMG_01_support_F,

...
class O_V_LSV_02_armed_F: LSV_02_armed_base_F
{
	...
	editorPreview = "\A3_Aegis\EditorPreviews_F_Aegis\Data\CfgVehicles\O_V_LSV_02_armed_F.jpg";
	scope = public;
	scopeCurator = public;
	side = TEast;
	faction = OPF_V_F;
	crew = O_V_Soldier_hex_F;
	typicalCargo[] = {O_V_Soldier_hex_F};
	textureList[] =
	{
		Black,0,
		GreenHex,0,
...
class O_V_LSV_02_unarmed_F: LSV_02_unarmed_base_F
{
	...
	editorPreview = "\A3_Aegis\EditorPreviews_F_Aegis\Data\CfgVehicles\O_V_LSV_02_unarmed_F.jpg";
	scope = public;
	scopeCurator = public;
	side = TEast;
	faction = OPF_V_F;
...
class O_V_LSV_02_AT_F: LSV_02_AT_base_F
{
	...
	editorPreview = "\A3_Aegis\EditorPreviews_F_Aegis\Data\CfgVehicles\O_V_LSV_02_AT_F.jpg";
	scope = public;
	scopeCurator = public;
	side = TEast;
	faction = OPF_V_F;
...
class O_V_LSV_02_armed_ghex_F: LSV_02_armed_base_F
{
	...
	typicalCargo[] = {O_V_Soldier_ghex_F};
	textureList[] =
	{
		Black,0,
		GreenHex,1,

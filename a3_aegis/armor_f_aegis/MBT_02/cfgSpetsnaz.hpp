...
class O_R_MBT_02_arty_F: O_MBT_02_arty_F
{
	author = $STR_A3_A_AveryTheKitty;
	class SimpleObject
	{
		...
		animate[] =
        {
            ...
            {wheel_podkolol5,0.52},
            {wheel_podkolol6,0.51},
            {wheel_podkolop2,0.54},
            {wheel_podkolop3,0.55},
            {wheel_podkolop4,0.55},
            {wheel_podkolop5,0.53},
            {wheel_podkolop6,0.52},
            {podkolol1_hide_damage,0},
            {podkolol2_hide_damage,0},
            {podkolol3_hide_damage,0},
            {podkolol4_hide_damage,0},
            ...
            {obsturret,0},
            {obsgun,0},
            {wheel_podkolop7,0.51},
            {wheel_podkolol7,0.51},
            {hatchdriver,0},
            {damagevezvelitele,0},
            {poklop_commander_damage,0},
            {poklop_gunner_damage,0},

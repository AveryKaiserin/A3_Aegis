class O_W_APC_Wheeled_02_rcws_v2_F: O_T_APC_Wheeled_02_rcws_v2_ghex_F
{
	author = $STR_A3_A_AveryTheKitty;
	editorPreview = "\A3_Aegis\EditorPreviews_F_Aegis\Data\CfgVehicles\O_W_APC_Wheeled_02_rcws_v2_F.jpg";
	scope = public;
	scopeCurator = public;
	side = TEast;
	faction = OPF_W_F;

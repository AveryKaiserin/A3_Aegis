class CfgVehicles
{
	...
	class Boat_Civil_03_base_F: Boat_F
    {
        attenuationEffectType = OpenCarAttenuation;
        insideSoundCoef = 1;
        soundEngineOnInt[] = {"\A3_Aegis\Sounds_F_Aegis\vehicles\boat\Boat_Civil_03\ext-slowboat-engine-start-02",db-15,1,100};
        soundEngineOnExt[] = {"\A3_Aegis\Sounds_F_Aegis\vehicles\boat\Boat_Civil_03\ext-slowboat-engine-start-02",db-15,1,100};
        soundEngineOffInt[] = {"\A3_Aegis\Sounds_F_Aegis\vehicles\boat\Boat_Civil_03\ext-slowboat-engine-stop-02",db-15,1,100};
        soundEngineOffExt[] = {"\A3_Aegis\Sounds_F_Aegis\vehicles\boat\Boat_Civil_03\ext-slowboat-engine-stop-02",db-15,1,100};
        buildCrash0[] = {"\A3\Sounds_F\Vehicles\boat\noises\metal_boat_crash_building_01",db5,1,200};
        buildCrash1[] = {"\A3\Sounds_F\Vehicles\boat\noises\metal_boat_crash_building_02",db5,1,200};
        buildCrash2[] = {"\A3\Sounds_F\Vehicles\boat\noises\metal_boat_crash_building_03",db5,1,200};
        soundBuildingCrash[] =
        {
            buildCrash0,1/3,
            buildCrash1,1/3,
        ...
        WoodCrash0[] = {"\A3\Sounds_F\Vehicles\boat\noises\metal_boat_crash_wood_01",db5,1,200};
        WoodCrash1[] = {"\A3\Sounds_F\Vehicles\boat\noises\metal_boat_crash_wood_02",db5,1,200};
        WoodCrash2[] = {"\A3\Sounds_F\Vehicles\boat\noises\metal_boat_crash_wood_03",db5,1,200};
        soundWoodCrash[] =
        {
            woodCrash0,1/3,
            woodCrash1,1/3,
        ...
        ArmorCrash0[] = {"\A3\Sounds_F\Vehicles\boat\noises\metal_boat_crash_armor_01",db10,1,200};
        ArmorCrash1[] = {"\A3\Sounds_F\Vehicles\boat\noises\metal_boat_crash_armor_02",db10,1,200};
        ArmorCrash2[] = {"\A3\Sounds_F\Vehicles\boat\noises\metal_boat_crash_armor_03",db10,1,200};
        soundArmorCrash[] =
        {
            ArmorCrash0,1/3,
            ArmorCrash1,1/3,
        ...
        soundGeneralCollision1[] = {"\A3\Sounds_F\Vehicles\boat\noises\metal_boat_crash_armor_01",db5,1,100};
        soundGeneralCollision2[] = {"\A3\Sounds_F\Vehicles\boat\noises\metal_boat_crash_armor_02",db5,1,100};
        soundGeneralCollision3[] = {"\A3\Sounds_F\Vehicles\boat\noises\metal_boat_crash_armor_03",db5,1,100};
        soundCrashes[] =
        {
            soundGeneralCollision1,1/3,
            soundGeneralCollision2,1/3,
        ...
        class Sounds
        {
            class IdleOut
            {
                sound[] = {"\A3_Aegis\Sounds_F_Aegis\vehicles\boat\Boat_Civil_03\ext-slowboat-engine-idle-03",db-7,1,150};
                frequency = 0.95+((rpm/	1200) factor[(100/	1200),(200/	1200)])*0.15;
                volume = engineOn*(((rpm/	1200) factor[(0/	1200),(30/	1200)])	*	((rpm/	1200) factor[(500/	1200),(300/	1200)]));
            };
            class Engine
            {
                sound[] = {"\A3_Aegis\Sounds_F_Aegis\vehicles\boat\Boat_Civil_03\ext-slowboat-engine-low-05",db-4,1.2,300};
                frequency = 0.95+((rpm/	1200) factor[(300/	1200),(600/	1200)])*0.2;
                volume = engineOn*(((rpm/	1200) factor[(200/	1200),(300/	1200)])	*	((rpm/	1200) factor[(600/	1200),(400/	1200)]));
            };
            class EngineMidOut
            {
                sound[] = {"\A3_Aegis\Sounds_F_Aegis\vehicles\boat\Boat_Civil_03\ext-slowboat-engine-hi-04",db-1,0.6,400};
                frequency = 0.95+((rpm/	1200) factor[(600/	1200),(900/	1200)])*0.2;
                volume = engineOn*(((rpm/	1200) factor[(350/	1200),(500/	1200)])	*	((rpm/	1200) factor[(1200/	1200),(900/	1200)]));
            };
            class EngineMaxOut
            {
                sound[] = {"\A3_Aegis\Sounds_F_Aegis\vehicles\boat\Boat_Civil_03\ext-slowboat-engine-hi-04",db2,1,500};
                frequency = 0.95+((rpm/	1200) factor[(700/	1200),(1000/	1200)])*0.3;
                volume = engineOn*((rpm/	1200) factor[(600/	1200),(1200/	1200)]);
            };
            class WaternoiseOutW0

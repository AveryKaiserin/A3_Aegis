/* Raven */
class O_Raven_Heli_Light_02_dynamicLoadout_F: O_Heli_Light_02_dynamicLoadout_F
{
	...
	side = TGuerrila;
	faction = IND_Raven_F;
	crew = I_Raven_Helipilot_F;
	typicalCargo[] = {I_Raven_Helipilot_F};
	textureList[] =
	{
		Black,1,
		Blackcustom,0
...
class O_Raven_Heli_Light_02_unarmed_F: O_Heli_Light_02_unarmed_F
{
	author = $STR_A3_A_AveryTheKitty;
    class SimpleObject
	{

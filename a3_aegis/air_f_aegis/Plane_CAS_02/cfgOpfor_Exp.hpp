...
class O_T_Plane_CAS_02_dynamicLoadout_ghex_F: Plane_CAS_02_dynamicLoadout_base_F
{
	author = $STR_A3_A_AveryTheKitty;
    class SimpleObject
	{
	...
	editorPreview = "\A3_Aegis\EditorPreviews_F_Aegis\Data\CfgVehicles\O_T_Plane_CAS_02_dynamicLoadout_ghex_F.jpg";
	scope = public;

class Aegis_B_T_Plane_Fighter_01_F: B_Plane_Fighter_01_F
{
...
class Aegis_B_T_Plane_Fighter_01_Stealth_F: B_Plane_Fighter_01_Stealth_F
{
	author = $STR_A3_A_AveryTheKitty;
    class SimpleObject
	{
...
class Aegis_B_T_Ejection_Seat_Plane_Fighter_01_F: Ejection_Seat_Plane_Fighter_01_base_F
{
	class SimpleObject
	{
		eden = false;

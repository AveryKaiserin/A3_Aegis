...
class B_W_Recon_GL_F: B_recon_GL_F
{
	...
	weapons[] =
	{
		arifle_SCAR_GL_black_snds_aco_pointer_f,
		hgun_P07_blk_snds_F,
        DefaultManWeapons
	};
	respawnWeapons[] =
...
class B_W_Recon_JTAC_F: B_recon_JTAC_F
{
    ...
    weapons[] =
	{
		arifle_SCAR_GL_black_snds_holo_pointer_f,
		hgun_P07_blk_snds_F,
        DefaultManWeapons,
...
class B_W_Recon_F: B_recon_F
{
    ...
    weapons[] =
	{
		arifle_SCAR_grip_black_snds_rco_pointer_f,
		hgun_P07_blk_snds_F,
        DefaultManWeapons,
		Binocular
	};
...
class B_W_Recon_LAT_F: B_recon_LAT_F
{
	...
	weapons[] =
	{
		arifle_SCAR_black_snds_aco_pointer_f,
		launch_NLAW_F,
		hgun_P07_blk_snds_F,
        DefaultManWeapons
	};

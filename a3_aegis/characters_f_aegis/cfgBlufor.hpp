...
class B_recon_F: B_Soldier_recon_base
{
    ...
    weapons[] =
    {
        arifle_SCAR_grip_snds_rco_pointer_f,
        hgun_P07_snds_F,
        DefaultManWeapons,
        Binocular
    };
...
class B_recon_LAT_F: B_Soldier_recon_base
{
    ...
    weapons[] =
    {
        arifle_SCAR_snds_aco_pointer_f,
        launch_NLAW_F,
        hgun_P07_snds_F,
        DefaultManWeapons
    };
...
class B_recon_JTAC_F: B_Soldier_recon_base
{
    ...
    weapons[] =
    {
        arifle_SCAR_GL_snds_holo_pointer_f,
        hgun_P07_snds_F,
        DefaultManWeapons,
        Laserdesignator
    };
...
class B_recon_GL_F: B_Soldier_recon_base
{
    ...
    weapons[] =
    {
        arifle_SCAR_GL_snds_aco_pointer_f,
        hgun_P07_snds_F,
        DefaultManWeapons
    };
    respawnWeapons[] =

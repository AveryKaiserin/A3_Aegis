class CfgFactionClasses
{
	...
	class Aegis_OPF_A_F
	{
		displayName = $STR_A3_A_CfgFactionClasses_Aegis_OPF_A_F0;
		priority = 3;
		side = TEast;
		icon = "\A3_Aegis\Data_F_Aegis\FactionIcons\CfgFactionClasses_Aegis_OPF_A_CA.paa";
	...
	// Arma 3 Aegis
	class Aegis_BLU_CTRG_tna_F
	{
		displayName = $STR_A3_A_CfgFactionClasses_Aegis_BLU_CTRG_tna_F0;
		priority = 3;
		side = TWest;
	...
	class Aegis_BLU_B_F
	{
		displayName = $STR_A3_A_CfgFactionClasses_Aegis_BLU_B_F0;
		priority = 3;
		side = TWest;
		icon = "\A3_Aegis\Data_F_Aegis\FactionIcons\CfgFactionClasses_Aegis_BLU_B_CA.paa";
		flag = "\A3\Data_F\Flags\flag_UK_CO.paa";
	};
	class Aegis_BLU_B_tna_F
	{
		displayName = $STR_A3_A_CfgFactionClasses_Aegis_BLU_B_tna_F0;
		priority = 3;
		side = TWest;
		icon = "\A3_Aegis\Data_F_Aegis\FactionIcons\CfgFactionClasses_Aegis_BLU_B_CA.paa";
		flag = "\A3\Data_F\Flags\flag_UK_CO.paa";
	};
	class Aegis_BLU_B_wdl_F
	{
		displayName = $STR_A3_A_CfgFactionClasses_Aegis_BLU_B_wdl_F0;
		priority = 3;
		side = TWest;
		icon = "\A3_Aegis\Data_F_Aegis\FactionIcons\CfgFactionClasses_Aegis_BLU_B_CA.paa";
		flag = "\A3\Data_F\Flags\flag_UK_CO.paa";
	};
	class Aegis_BLU_ION_F
	{
		displayName = $STR_A3_A_CfgFactionClasses_Aegis_BLU_ION_F0;
		priority = 3;
		side = TWest;
		icon = "\A3_Aegis\Data_F_Aegis\FactionIcons\icon_ION_CA.paa";
		flag = "\A3_Aegis\Data_F_Aegis\Flags\flag_ION_CO.paa";
	};
	class Aegis_OPF_V_tna_F
	{
		displayName = $STR_A3_A_CfgFactionClasses_Aegis_OPF_V_tna_F0;
		priority = 3;
		side = TEast;
		icon = "\A3\Data_F_Exp\FactionIcons\icon_VIPER_CA.paa";
		flag = "\A3\Data_F_Exp\Flags\flag_Viper_CO.paa";
	};
	class Aegis_OPF_R_ard_F
	{
		displayName = $STR_A3_A_CfgFactionClasses_Aegis_OPF_R_ard_F0;
		priority = 3;
		side = TEast;
		icon = "\A3\Data_F_Enoch\FactionIcons\icon_RUS_CA.paa";
		flag = "\A3_Aegis\Data_F_Aegis\Flags\flag_RUS_CO.paa";
	};
	class Aegis_IND_E_ard_F
	{
		displayName = $STR_A3_A_CfgFactionClasses_Aegis_IND_E_ard_F0;
		priority = 3;
		side = TGuerrila;

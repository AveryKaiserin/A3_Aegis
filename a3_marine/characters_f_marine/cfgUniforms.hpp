...
// Arma 3 Marine
// USMC
class Marine_B_MCUCombatFatigues_01_desert_F: B_Soldier_F
{
	scope = protected;
...
class Marine_B_MCUCombatFatigues_01_wdl_F: B_Soldier_F
{
	scope = protected;
	scopeCurator = private;
...
class Marine_B_MCUCombatFatigues_01_Tshirt_desert_F: B_soldier_AR_F
{
	scope = protected;
	scopeCurator = private;
...
class Marine_B_MCUCombatFatigues_01_Tshirt_wdl_F: B_soldier_AR_F
{
	scope = protected;
	scopeCurator = private;
...
class Marine_B_MCUReconFatigues_01_desert_F: B_Soldier_SL_F
{
	scope = protected;
	scopeCurator = private;
...
class Marine_B_MCUReconFatigues_01_wdl_F: B_Soldier_SL_F
{
	scope = protected;
	scopeCurator = private;

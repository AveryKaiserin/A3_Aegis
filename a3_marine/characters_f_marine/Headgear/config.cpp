...
class CfgWeapons
{
	...
	class Marine_H_Booniehat_desert: H_Booniehat_khk
	{
		...
		displayName = $STR_A3_M_CfgWeapons_Marine_H_Booniehat_desert0;
	...
	class Marine_H_Booniehat_desert_hs: Marine_H_Booniehat_desert
	{
		...
		displayName = $STR_A3_M_CfgWeapons_Marine_H_Booniehat_desert_hs0;
	...
	{
		author = $STR_A3_A_AveryTheKitty;
		displayName = $STR_A3_M_CfgWeapons_Marine_H_Booniehat_mwdl0;
	...
	class Marine_H_Booniehat_mwdl_hs: Marine_H_Booniehat_mwdl
	{
		...
		displayName = $STR_A3_M_CfgWeapons_Marine_H_Booniehat_mwdl_hs0;
		model = "\A3\Characters_F_EPB\Common\booniehat_hs.p3d";
		class ItemInfo: ItemInfo
		{
			uniformModel = "\A3\Characters_F_EPB\Common\booniehat_hs.p3d";
	...
	{
		author = $STR_A3_A_AveryTheKitty;
		displayName = $STR_A3_M_CfgWeapons_Marine_H_MilCap_desert0;
	...
	{
		author = $STR_A3_A_AveryTheKitty;
		displayName = $STR_A3_M_CfgWeapons_Marine_H_MilCap_mwdl0;

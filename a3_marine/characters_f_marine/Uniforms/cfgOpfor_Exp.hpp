class U_O_T_CombatUniform_oceanic_F: Uniform_Base
{
	...
	{
		uniformModel = "-";
		uniformClass = O_T_Fatigues_01_oceanic_F;
		containerClass = Supply40;
		mass = 80;
	};
};
class U_O_T_officer_noInsignia_oceanic_F: Uniform_Base
{
	author = $STR_A3_A_AveryTheKitty;
	scope = public;
	...
	{
		uniformModel = "-";
		uniformClass = O_T_LightFatigues_01_oceanic_F;
		containerClass = Supply40;
		mass = 60;
	};
};
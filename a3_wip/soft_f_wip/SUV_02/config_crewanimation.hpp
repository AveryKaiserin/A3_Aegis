...
class CfgMovesMaleSdr: CfgMovesBasic
{
	class States
	{
		...
		{
			file = "A3_Aegis\soft_f_aegis\SUV_02\data\Anim\SUVmatildaTurnOutPose.rtm";
			interpolateTo[] =
			{
		...
		{
			file = "A3_Aegis\soft_f_aegis\SUV_02\data\Anim\SUVmatildaTurnInPose.rtm";
			leftHandIKCurve[] = {0};
            rightHandIKCurve[] = {0};
		};		
		...
		{
			actions = DeadActions;
			file = "A3_Aegis\soft_f_aegis\SUV_02\data\Anim\SUVmatildaDeath.rtm";
			speed = 1e+010;
			terminal = 1;
			soundEnabled = 0;
			looped = 0;
		...
		{
			file = "A3_Aegis\soft_f_aegis\SUV_02\data\Anim\SUVmatildaTurnIn.rtm";
			interpolateTo[] =
			{
				"ArmoredSUV_KIA_Gunner_PMC", 1
			};			
		...
		{
			file = "A3_Aegis\soft_f_aegis\SUV_02\data\Anim\SUVmatildaTurnOut.rtm";
			interpolateTo[] =
			{
				"ArmoredSUV_KIA_Gunner_PMC", 1
			};			
		...
		{
			file="A3_Aegis\soft_f_aegis\SUV_02\data\Anim\SUV_Cargo";
			interpolateTo[]=
			{
				"SUV_KIA_Cargo_EP1",
				1
		...
		{
			actions="DeadActions";
			file="A3_Aegis\soft_f_aegis\SUV_02\data\Anim\SUV_KIA_Cargo";
			speed=1e+010;
			terminal=1;
			soundEnabled=0;
			looped=0;
		...
		{
			file="A3_Aegis\soft_f_aegis\SUV_02\data\Anim\SUV_Cargo01";
			interpolateTo[]=
			{
				"SUV_KIA_Cargo01_EP1",
				1
		...
		{
			actions="DeadActions";
			file="A3_Aegis\soft_f_aegis\SUV_02\data\Anim\SUV_KIA_Cargo01";
			speed=1e+010;
			terminal=1;
			soundEnabled=0;
			looped=0;
		...
		{
			file="A3_Aegis\soft_f_aegis\SUV_02\data\Anim\SUV_Cargo02";
			interpolateTo[]=
			{
				"SUV_KIA_Cargo02_EP1",
				1
		...
		{
			actions="DeadActions";
			file="A3_Aegis\soft_f_aegis\SUV_02\data\Anim\SUV_KIA_Cargo02";
			speed=1e+010;
			terminal=1;
			soundEnabled=0;
			looped=0;
		...
		{
			file="A3_Aegis\soft_f_aegis\SUV_02\data\Anim\SUV_Driver";
			interpolateTo[]=
			{
				"SUV_KIA_Driver_EP1",
				1
		...
		{
			actions="DeadActions";
			file="A3_Aegis\soft_f_aegis\SUV_02\data\Anim\SUV_KIA_Driver";
			speed=1e+010;
			terminal=1;
			soundEnabled=0;
			looped=0;

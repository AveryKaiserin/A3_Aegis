class CfgVehicles
{
	...
	class DEGA_ArmoredSUV_Base: Car_F
	{
		...
		class HitPoints: HitPoints
		{
			...
			class HitGlass1: HitGlass1 {armor=0.18; explosionShielding = 0.8; minimalHit = 0.1; name = "glass1"; passThrough = 0; radius = 0.11; visual = "glass1";};
			class HitGlass2: HitGlass1 {armor=0.18; explosionShielding = 0.8; minimalHit = 0.1; name = "glass2"; passThrough = 0; radius = 0.11; visual = "glass2";};
			class HitGlass3: HitGlass1 {armor=0.18; explosionShielding = 0.8; minimalHit = 0.1; name = "glass3"; passThrough = 0; radius = 0.11; visual = "glass3";};
			class HitGlass4: HitGlass1 {armor=0.18; explosionShielding = 0.8; minimalHit = 0.1; name = "glass4"; passThrough = 0; radius = 0.11; visual = "glass4";};
			class HitGlass5: HitGlass1 {armor=0.18; explosionShielding = 0.8; minimalHit = 0.1; name = "glass5"; passThrough = 0; radius = 0.11; visual = "glass5";};
			class HitGlass6: HitGlass1 {armor=0.18; explosionShielding = 0.8; minimalHit = 0.1; name = "glass6"; passThrough = 0; radius = 0.11; visual = "glass6";};
			class HitGlass7: HitGlass1 {armor=0.18; explosionShielding = 0.8; minimalHit = 0.1; name = "glass7"; passThrough = 0; radius = 0.11; visual = "glass7";};
			class HitGlass8: HitGlass1 {armor=0.18; explosionShielding = 0.8; minimalHit = 0.1; name = "glass8"; passThrough = 0; radius = 0.11; visual = "glass8";};
		};
		...
		class textureSources
		{
			class GunArmoured
			{
				...
				author="Deltagamer";
				textures[] = {"A3_Aegis\soft_f_aegis\SUV_02\data\armoredsuv_bodygun_co.paa", "A3_Aegis\soft_f_aegis\SUV_02\data\armoredsuv_interiergun_co.paa"};
				factions[]= {};
				materials[] ={"A3_Aegis\soft_f_aegis\SUV_02\data\suv_armouredbody.rvmat", "A3_Aegis\soft_f_aegis\SUV_02\data\suv_interier.rvmat"};
			};	
			class Armoured
			{
				displayName="Armoured (Unarmed)";
				author="Deltagamer";
				textures[] = {"A3_Aegis\soft_f_aegis\SUV_02\data\armoredsuv_body_co.paa", "A3_Aegis\soft_f_aegis\SUV_02\data\armoredsuv_interier_co.paa"};
				factions[]= {};
				materials[] ={"A3_Aegis\soft_f_aegis\SUV_02\data\suv_body.rvmat", "A3_Aegis\soft_f_aegis\SUV_02\data\suv_interier.rvmat"};
			};	
		};
		textureList[]= {};		
	};

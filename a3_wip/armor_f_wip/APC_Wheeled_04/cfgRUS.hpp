...
{
    author = $STR_A3_A_AveryTheKitty;
	editorPreview = /*"\A3_Wip\EditorPreviews_F_Wip\Data\CfgVehicles\O_R_APC_Wheeled_04_cannon_v2_F.jpg"*/ "";
	scope = public;
	scopeCurator = public;
	side = TEast;
	faction = OPF_R_F;
...
{
    author = $STR_A3_A_AveryTheKitty;
	editorPreview = /*"\A3_Wip\EditorPreviews_F_Wip\Data\CfgVehicles\O_R_APC_Wheeled_04_cannon_v2_ard_F.jpg"*/ "";
	faction = OPF_R_ard_F;
	crew = O_R_crew_ard_F;
	typicalCargo[] = {O_R_crew_ard_F};
